    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{ route('admin.comment.update', $comment->id) }}">
                    {{ csrf_field() }}
                            ...
                            <div class="col-sm-10">
                                <select name="employee_id" class="form-control select2" id="inputEmployee"
                                    ...
                                    @foreach($employees as $employee)
                                        <option {{ $comment->employee_id == $employee->id ? 'selected="selected"' : ''}} value="{{ $employee->id }}">{{ $employee->full_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-10">
                                <div class="checkbox icheck">
                                    ...
                                    <input type="checkbox" name="approved" value="1"
                                           id="inputApproved" {{ old('approved', $comment->approved) == 1 ? 'checked' : '' }}>
                                </div>
